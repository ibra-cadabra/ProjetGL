...
%JAVACMD% %JAVA_OPTS% --module-path %JAVAFX_HOME%/lib --add-modules javafx.controls,javafx.fxml -classpath %CLASSPATH% -Dapp.name="run" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" fr.ul.miage.gestionRestaurant.Main %CMD_LINE_ARGS%
